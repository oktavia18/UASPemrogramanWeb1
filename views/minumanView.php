...
<body>
    <h1>Data Minuman</h1>
    <a href="?page=minumanAdd" class="add-button">+ Tambah Data Baru</a>
    <table>
        <thead>
            <tr>
                <th>No</th>
            ...
            while ($data = mysqli_fetch_array($sql)) { ?>
                <tr>
                    ...
                    <td class="action-links">
                        ...
                        <a href="?page=minumanDelete&id=<?= $data['id_minuman']; ?>" onclick="return confirm('Apakah Anda yakin ingin menghapus data ini?');">Hapus</a>
                    </td>
                </tr>
            <?php } ?>
        </tbody>
